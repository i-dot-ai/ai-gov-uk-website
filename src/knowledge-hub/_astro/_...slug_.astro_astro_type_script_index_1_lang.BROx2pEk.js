import{i as a,x as r}from"./lit-element.CBixG2jI.js";class e extends a{static properties={category:{type:String,attribute:"category"},type:{type:String,attribute:"type"},queryParams:{type:String,attribute:"query-params"}};constructor(){super(),this.category="",this.type="",this.queryParams=""}createRenderRoot(){return this.innerHTML="",this}connectedCallback(){super.connectedCallback(),this.queryParams=new URLSearchParams(window.location.search).get("directTo")||""}render(){return r`
